...
TEST_CASE("Scalar multiplication with zero"){
    ...
    REQUIRE(B(0,0) == (0.0f)); //5*0=0
    REQUIRE(B(0,1) == (0.0f)); //-3*0=0
    REQUIRE(B(1,0) == (0.0f)); //2*0=0
    REQUIRE(B(1,1) == (0.0f));//7*0=0
...
TEST_CASE("Scalar Multiplication  with a negative number"){
    ...
    REQUIRE(B(0,0) == (-3.0f)); //1*-3=-3
    REQUIRE(B(0,1) == (6.0f)); //-2*-3=6
    REQUIRE(B(1,0) == (-9.0f)); //3*-3=-9
    REQUIRE(B(1,1) == (12.0f));//-4*-3=12
}
...
TEST_CASE("Scalar Multiplication with decimal numbers"){
    ...
    REQUIRE(B(0,0)== (1.0f));//2*0.5=1
    REQUIRE(B(0,1)== (2.0f));//4*0.5=2
    REQUIRE(B(1,0)== (3.0f));//6*0.5=3
    REQUIRE(B(1,1)== (4.0f));//8*0.5=4
}
...
TEST_CASE("Scalar multiplication with negative decimal") {
    ...
    REQUIRE(B(0,0) == (-0.5f));  // 1 * -0.5 = -0.5
    REQUIRE(B(0,1) == (1.0f));   // -2 * -0.5 = 1
    REQUIRE(B(1,0) == (-1.5f));  // 3 * -0.5 = -1.5
    REQUIRE(B(1,1) == (2.0f));   // -4 * -0.5 = 2
}
...
TEST_CASE("Scalar multiplication does not modify original matrix"){
    ...
    REQUIRE(A(0,0)== (1.0f));// confirms A(0,0) is still 1
    REQUIRE(A(0,1)== (2.0f));//confirms that A(0,1) is still 2
    REQUIRE(A(1,0)== (3.0f));//A(1,0) is still 3
    REQUIRE(A(1,1)== (4.0f));//A(1,1) is still 4
}