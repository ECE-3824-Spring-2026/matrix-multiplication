...
TEST_CASE("Scalar division by Decimal number"){
    ...
    REQUIRE(B(0,0) == Approx(2.0f));// 1/0.5=2
    REQUIRE(B(0,1) == Approx(4.0f));// 2/0.5=4
    REQUIRE(B(1,0) == Approx(6.0f));// 3/0.5=6
...
TEST_CASE("Scalar division Does not modify original matrix"){
    ...
    REQUIRE(A(0,0) == Approx(3.0f));// confirms A(0,0)=3
    REQUIRE(A(0,1) == Approx(6.0f));// confirms A(0,1)=6
    REQUIRE(A(1,0) == Approx(9.0f));// confirms A(1,0)=9
    REQUIRE(A(1,1) == Approx(12.0f));// confirms A(1,1)=12
}